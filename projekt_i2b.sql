...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Stř 01. čen 2022, 14:02
...
(26, 10, '2022-06-01', '06:00:00', 1),
(27, 10, '2022-06-01', '16:00:00', 2),
(28, 4, '2022-06-05', '08:00:00', 2),
(43, 5, '2022-06-06', '09:00:00', 2),
(46, 11, '2022-06-03', '13:00:00', 2),
(49, 11, '2022-06-04', '16:00:00', 2),
(50, 11, '2022-06-06', '15:00:00', 2);
...
(10, '<b>ahoj</b>', '356a192b7913b04c54574d18c28d46e6395428ab', 3),
(11, 'suss', 'a0f1490a20d0211c997b44bc357e1972deab8ae3', 3);
...
--
ALTER TABLE `rezervace`
  MODIFY `ID_rezervace` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `uzivatele`
  MODIFY `ID_uzivatele` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
